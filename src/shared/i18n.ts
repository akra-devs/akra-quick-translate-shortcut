const FALLBACK_MESSAGES: Record<string, string> = {
  ...
  statusFailed: "Failed",
  statusNoText: "No visible text found",
  ...
  supportDevelopmentButton: "Support Akra",
  supportDevelopmentDescription: "Akra Quick Translate stays free. Your support helps with updates and Chrome compatibility work.",
  supportDevelopmentEyebrow: "Support",
